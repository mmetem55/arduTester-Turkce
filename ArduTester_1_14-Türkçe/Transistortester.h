...
// If none is actually selected, LANG_SELECTED is not set.
   ...
   const unsigned char TestRunning[] MEM_TEXT = "Test ediliyor";
   const unsigned char BatWeak[] MEM_TEXT = "zayif";
   const unsigned char BatEmpty[] MEM_TEXT = "bitmis!";
   const unsigned char TestFailed2[] MEM_TEXT = "hasarli ";
   const unsigned char Bauteil[] MEM_TEXT = "parca";
//   const unsigned char Diode[] MEM_TEXT = "Diyot: ";
   const unsigned char Triac[] MEM_TEXT = "Triak";
   const unsigned char Thyristor[] MEM_TEXT = "Tristor.";
   const unsigned char Unknown[] MEM_TEXT = " Bilinmiyor";
   const unsigned char TestFailed1[] MEM_TEXT = "Bilinmiyor,bozuk";
   const unsigned char Detected[] MEM_TEXT = " olculdu";
   const unsigned char TestTimedOut[] MEM_TEXT = "Zaman Asimi!";
   #define Cathode_char 'C'
 #ifdef WITH_SELFTEST
   const unsigned char SELFTEST[] MEM_TEXT = "test modu..";
   const unsigned char RELPROBE[] MEM_TEXT = "proplari ayir"; // or "separate pins!";
   const unsigned char ATE[] MEM_TEXT = "Test Bitti";
 #endif
 #ifdef WITH_MENU
   const unsigned char SELECTION_str[] MEM2_TEXT = "Secim:";
   const unsigned char TESTER_str[] MEM2_TEXT = "Transistor";
   const unsigned char VOLTAGE_str[] MEM2_TEXT = "Voltaj";
   const unsigned char SHOW_str[] MEM2_TEXT = "Data goster";	// "Show data"
   const unsigned char OFF_str[] MEM2_TEXT = "Kapat";
   const unsigned char F_GEN_str[] MEM2_TEXT = "f-Jenerator";
  #ifdef PWM_SERVO
 ...
 const unsigned char PWM_10bit_str[] MEM2_TEXT = "10-bit PWM";
  ...
  #endif
   const unsigned char SetCapCorr_str[] MEM2_TEXT = {'C','(',LCD_CHAR_U,'F',')','-','d','u','z','e','l','t','m','e',0};
   const unsigned char TURN_str[] MEM2_TEXT = "turn!";	
   const unsigned char FULLCHECK_str[] MEM2_TEXT = "Selftest";
   const unsigned char SHORT_PROBES_str[] MEM2_TEXT = "Problari birlestir!";
#ifndef NO_FREQ_COUNTER
   const unsigned char FREQ_str[] MEM2_TEXT = "Frekans";
 #ifdef WITH_FREQUENCY_DIVIDER
   const unsigned char FScaler_str[] MEM2_TEXT = "F-Scaler";
 #endif
#endif
  #if PROCESSOR_TYP == 644
   const unsigned char HFREQ_str[] MEM2_TEXT = "Frekans> 2MHz";
...
// Strings, which are not dependent of any language
 const unsigned char Bat_str[] MEM_TEXT = "Pil ";
...
// Notice, that the LCD has only 16 character in each line!
 ...
 const unsigned char HelpCalibration_str[] PROGMEM = {'K','a','l','i','b','r','e',' ','e','d','i','l','m','e','d','i'
...
,0};
 ...
 const unsigned char VERSION_str[] MEM_TEXT = "ArduTester V1.14k";
#endif
#ifdef SHOW_ICE
